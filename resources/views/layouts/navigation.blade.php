    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex justify-end items-center space-x-2 mx-auto relative"> --}}
                ...
                {{-- <button class="btn btn-outline-dark" type="button" id="switchTheme">Dark Mord</button>
            </div>
            </div> --}}

            <button id="switchTheme" class="h-10 w-10 flex justify-center items-center focus:outline-none text-yellow-500 mt-3">
